        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 sm:col-span-2">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-xl font-semibold">ATS Pass</span>
            </div>
            <p className="text-gray-400 mb-6 max-w-md text-sm sm:text-base">
              The AI-powered resume builder that ensures your resume passes Applicant Tracking Systems 
              and gets you more interviews.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors text-sm sm:text-base">Templates</a></li>
